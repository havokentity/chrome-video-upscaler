...
function generateWgslMatrixConvolutionPassExecutable(artifactOrReport, passIndex) {
  ...
  const lines = [
    ...
    ' *',
    ' * This file is runtime-wired by the experimental shader-native WebGPU',
    ' * path and kept generated for review and CPU reference checks.',
    ' */',
    '',
    'struct ArtCnnNativeParams {',
    '  source_size: vec2u,',
...
function formatWgslF16Mat4(values) {
  if (values.length !== 16) {
    throw new Error(`Expected sixteen f16 matrix values, got ${values.length}.`);
  }
